module GroveApi.Governance.ProposalVoteReceiptService.Models exposing
    ( ProposalVoteReceipt
...
import GroveApi.Governance.Common.Models exposing (DisplayAccount)
import GroveApi.Governance.ProposalService.Models exposing (Proposal)
