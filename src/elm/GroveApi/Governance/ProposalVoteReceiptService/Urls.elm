module GroveApi.Governance.ProposalVoteReceiptService.Urls exposing (voteReceiptsRequestUrl)

import GroveApi.Common.Url
import GroveApi.Governance.ProposalVoteReceiptService.Models exposing (ProposalVoteReceiptRequest)
...
voteReceiptsRequestUrl apiBaseUrlMap network request =
    ...
    in
    GroveApi.Common.Url.buildApiUrl apiBaseUrlMap network "v2/governance/proposal_vote_receipts" finalQueryParams
