module GroveApi.Governance.CompService.Decoders exposing (accountCompDistributionResponseDecoder, marketCompDistributionResponseDecoder)

import GroveApi.Governance.CompService.Models
    exposing
