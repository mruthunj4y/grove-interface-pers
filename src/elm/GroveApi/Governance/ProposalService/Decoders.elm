module GroveApi.Governance.ProposalService.Decoders exposing (proposalDecoder, proposalStateDecoder, proposalWithDetailDecoder, proposalsResponseDecoder, proposalsWithDetailResponseDecoder)

import GroveApi.Common.Decoders exposing (apiErrorDecoder, paginationSummaryDecoder)
import GroveApi.Governance.Common.Decoders exposing (displayAccountDecoder, proposalActionDecoder)
import GroveApi.Governance.ProposalService.Models
    exposing
        ( Proposal
        , ProposalState
        , ProposalStateEnum(..)
