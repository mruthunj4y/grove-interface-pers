module GroveApi.Governance.ProposalService.Urls exposing (proposalsRequestUrl)

import GroveApi.Common.Url
import GroveApi.Governance.ProposalService.Encoders exposing (encodeProposalStateEnum)
import GroveApi.Governance.ProposalService.Models exposing (ProposalsRequest)
        ...
        finalQueryParams =
            case proposalRequest.state of
                ...
                Nothing ->
                    intermediateQueryParams
    in
    GroveApi.Common.Url.buildApiUrl apiBaseUrlMap network "v2/governance/proposals" finalQueryParams
